...
<html>
    ...
    <body>
        ...
        On vient de créer un objet javascript XHR, qui permet de communiquer de manière asynchrone (sans blocage de page en cas d'attente) avec un serveur web et le navigateur de l'utilisateur en utilisant l'http
    </body>
</html>
